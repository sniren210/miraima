	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight">
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					<li <?php if ($this->uri->segment(1) == 'home') {echo "class='colorlib-active'";} ?>><a href="<?=  base_url('home') ?>">Home</a></li>
					<li <?php if ($this->uri->segment(1) == 'mading') {echo "class='colorlib-active'";} ?>><a href="<?=  base_url('mading') ?>">Mading</a></li>
					<li <?php if ($this->uri->segment(1) == 'eskul') {echo "class='colorlib-active'";} ?>><a href="<?=  base_url('eskul') ?>">Eskul</a></li>
					<li <?php if ($this->uri->segment(1) == 'ajuan') {echo "class='colorlib-active'";} ?>><a href="<?=  base_url('ajuan') ?>">Ajuan</a></li>
					<li <?php if ($this->uri->segment(1) == 'tentang') {echo "class='colorlib-active'";} ?>><a href="">Tentang</a></li>
			...
			<div class="footer" style="position: relative; top: 50px;">
				<h1 id="colorlib-logo" class="mb-4"><a href="<?=  base_url() ?>" style="background-image: url(<?=  base_url('assets/mading') ?>/images/bg_1.jpg);">Miraima</a></h1>
